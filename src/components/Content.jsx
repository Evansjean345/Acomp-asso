    ...
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 bg-white">
      <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
        <div className="w-full lg:w-6/12">
          <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9 text-black">
            Le projet
          </h2>
      ...
      <div className="relative mt-24">
        <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
          <div className="z-20 w-12 h-12 bg-[#ffc58a]  rounded-full flex justify-center items-center">
    ...
    {/* Mission start */}
      <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
        <div className="w-full lg:w-6/12">
          ...
          <p className="font-normal text-base leading-6 text-gray-800 mt-6 w-full lg:w-10/12 xl:w-9/12">
          ...
          <p className="font-normal text-base leading-6 text-gray-800 w-full lg:w-10/12 xl:w-9/12 mt-10">
