            ...
            <div className={show ? "bg-white flex justify-between items-center px-4" : "flex justify-between items-center px-4"}>
              ...
              <div className=" flex items-center">
                {show && (
                  ...
                  >
                    <li className="flex cursor-pointer text-gray-600 text-4xl justify-center leading-3 tracking-normal mt-20 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                      <a href="javascript:void(0)">
                        <span className="ml-2 font-bold">Home</span>
                      </a>
                    </li>
                    <li
                      className="flex flex-col cursor-pointer text-gray-600  text-4xl leading-3 tracking-normal mt-20 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none items-center justify-center"
                    ...
                    <li className="flex cursor-pointer text-gray-600 text-4xl justify-center leading-3 mt-20 tracking-normal py-2 hover:text-indigo-700  items-center focus:text-indigo-700 focus:outline-none">
                      <a href="javascript:void(0)">
